...
public class Utils {
    ...
    static {
        try {
            ...
            successCounter = 0;
            fails = new ArrayList<>();
            LicenseStore.getInstance().addLicenses(new JsonLicenseParser().readLicenseDir("share/licenses/json"));
            LicenseStore.getInstance().connector(new JsonLicenseCompatibilityParser().readLicenseConnection("share/licenses/connections/dwheeler.json"));
